...
import in.spcct.spacedoc.cdi.util.SingletonSupplier;
import lombok.Data;
 ...
 * <p>
 * May store multiple objects of the same type as ObjectVariants.
 */
public class Registry {
     ...
     * @param <T>
     */
    public static <T> void registerSingleton(Class<T> clazz, int priority, Supplier<T> supplier) {
        register(clazz, priority, new SingletonSupplier<>(supplier));
    }
     ...
     * @param <T>
     */
    public static <T> void registerSingleton(Class<T> clazz, int priority, Variant variant, Supplier<T> supplier) {
        register(clazz, priority, variant, new SingletonSupplier<>(supplier));
    }
